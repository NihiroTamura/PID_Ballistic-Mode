...
volatile float POT_desired[6] = {
  600.0, 580.0, 650.0, 675.0, 325.0, 0.0
};

//---ADRC--------------------------------------------------------------------
/*//  PDゲイン（単自由度）No1(2025/12/08)*/
const float kp[6] = {
  12000.0, 12000.0, 8000.0, 2000.0, 7000.0, 0.0
};
const float kd[6] = {
  250.0, 250.0, 400.0, 100.0, 300.0, 0.0
};
...
//  制御入力係数
/*No1*/
float input_coef[6] = {30000.0, 30000.0, 30000.0, 40000.0, 30000.0, 0.0};
