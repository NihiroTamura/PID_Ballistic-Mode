...
volatile float POT_desired[6] = {
  350.0, 400.0, 500.0, 400.0, 0.0, 0.0
};

//---ADRC--------------------------------------------------------------------
/*//  PDゲイン（単自由度）No1(2025/00/00)
const float kp[6] = {
...
/*//  PDゲイン（単自由度）調整用*/
const float kp[6] = {
  1000.0, 1000.0, 3000.0, 1000.0, 0.0, 0.0
};
const float kd[6] = {
...
/*調整用*/
float lamda_0[6] = {300.0, 300.0, 300.0, 300.0, 0.0, 0.0};
...
/*調整用*/
float input_coef[6] = {30000.0, 30000.0, 30000.0, 30000.0, 0.0, 0.0};
