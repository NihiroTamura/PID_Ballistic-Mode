...
//---ADRC--------------------------------------------------------------------
/*//  PDゲイン(POT No.[43, 29, 20, 19, -, -]) No1(2025/12/08)*/
const float kp[6] = {
  12000.0, 14000.0, 4000.0, 19000.0, 0.0, 0.0
};
const float kd[6] = {
  650.0, 600.0, 150.0, 240.0, 0.0, 0.0
};
...
//  オブザーバゲイン
//  オブザーバーの極(-λ₀の重根)(POT No.[43, 29, 20, 19, -, -])
/*No1*/
float lamda_0[6] = {300.0, 300.0, 800.0, 300.0, 0.0, 0.0};
...
//  (POT No.[43, 29, 20, 19, -, -])
/*No1*/
float input_coef[6] = {20000.0, 20000.0, 60000.0, 30000.0, 0.0, 0.0};
...
//  VEABへのPWM出力値(POT No.[43a, 43b, 29a, 29b, 20a, 20b, 19a, 19b, -, -, -, -])
