...
#define TEENSY_IP 192, 168, 1, 118 // IP that the teensy 4.1 will have ※teensyのIPは192.168.[0-3].[0-255]
...
void setup() {
  ...
  set_microros_native_ethernet_udp_transports(teensy_mac, teensy_ip, agent_ip, 9997);
