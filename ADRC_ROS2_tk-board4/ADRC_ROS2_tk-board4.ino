...
#define TEENSY_IP 192, 168, 1, 119 // IP that the teensy 4.1 will have ※teensyのIPは192.168.[0-3].[0-255]
...
volatile float POT_desired[6] = {
  500.0, 700.0, 350.0, 160.0, 370.0, 0.0
};
...
/*調整用*/
float lamda_0[6] = {300.0, 300.0, 300.0, 300.0, 300.0, 0.0};
...
/*調整用*/
float input_coef[6] = {30000.0, 30000.0, 30000.0, 30000.0, 30000.0, 0.0};
