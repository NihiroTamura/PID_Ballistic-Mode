...
//  角度目標値の初期値{腕の閉190-394開, 腕の下287-534上, 上腕の旋回内87-500外, 肘の伸124-635曲, 前腕の旋回内98-900外, 小指側縮48-822伸}
/*No1*/
volatile float POT_desired[6] = {
  260.0, 400.0, 180.0, 500.0, 600.0, 500.0
};
  ...
  while(1) {
    ...
    if(1) {
      ...
      for(int i = 0; i < SPEED_DESIRED; i++){
        if(sub_count == 0){
          sub[i+7] = SPEED_desired[i];
        }

        SPEED_desired[i] = sub[i+7];
      }
...
void SerialPrint_function(){
  ...
  Serial.print(",");
  Serial.print(outputPD[1]);
  Serial.print(",");
  Serial.print(outputPD_speed[1]);
  Serial.print(",");
  Serial.print(POT_desired[1]);
  Serial.print(",");
  Serial.print(POT_desired_previous[1]);
  Serial.print(",");
  Serial.print(Speed_check[1]);
  Serial.print(",");
  Serial.print(check_value[1]);
  Serial.print(",");
  Serial.print(SPEED_desired[1]);
  /**/
  Serial.print(",");
  ...
  Serial.print(",");
  Serial.print(outputPD[2]);
  Serial.print(",");
  Serial.print(outputPD_speed[2]);
  Serial.print(",");
  Serial.print(POT_desired[2]);
  Serial.print(",");
  Serial.print(POT_desired_previous[2]);
  Serial.print(",");
  Serial.print(Speed_check[2]);
  Serial.print(",");
  Serial.print(check_value[2]);
  Serial.print(",");
  ...
  Serial.print(",");
  Serial.print(outputPD[3]);
  Serial.print(",");
  Serial.print(outputPD_speed[3]);
  Serial.print(",");
  Serial.print(POT_desired[3]);
  Serial.print(",");
  Serial.print(POT_desired_previous[3]);
  Serial.print(",");
  Serial.print(Speed_check[3]);
  Serial.print(",");
  Serial.print(check_value[3]);
  Serial.print(",");
  Serial.print(SPEED_desired[3]);
  /**/
  Serial.print(",");
  ...
  Serial.print(",");
  Serial.print(outputPD[4]);
  Serial.print(",");
  Serial.print(outputPD_speed[4]);
  Serial.print(",");
  Serial.print(POT_desired[4]);
  Serial.print(",");
  Serial.print(POT_desired_previous[4]);
  Serial.print(",");
  Serial.print(Speed_check[4]);
  Serial.print(",");
  Serial.print(check_value[4]);
  Serial.print(",");
  Serial.print(SPEED_desired[4]);
  /**/
  Serial.print(",");
  ...
  Serial.print(",");
  Serial.print(outputPD[5]);
  Serial.print(",");
  Serial.print(outputPD_speed[5]);
  Serial.print(",");
  Serial.print(POT_desired[5]);
  Serial.print(",");
  Serial.print(POT_desired_previous[5]);
  Serial.print(",");
  Serial.print(Speed_check[5]);
  Serial.print(",");
  Serial.print(check_value[5]);
  Serial.print(",");
  Serial.println(SPEED_desired[5]);
}
