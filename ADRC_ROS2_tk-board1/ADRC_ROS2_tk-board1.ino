...
/*//  PDゲイン（単自由度）調整用
const float kp[6] = {
  9000.0, 3000.0, 6000.0, 6000.0, 6000.0, 7000.0
};
const float kd[6] = {
  300.0, 183.0, 420.0, 520.0, 230.0, 300.0
};*/
...
/*調整用
float lamda_0[6] = {300.0, 800.0, 300.0, 300.0, 500.0, 500.0};*/
...
/*調整用
float input_coef[6] = {30000.0, 80000.0, 30000.0, 30000.0, 20000.0, 30000.0};*/
